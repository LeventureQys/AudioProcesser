...
#include "../signal_processing/fft4g.h"
#include "pitch_internal.h"
#include "pole_zero_filter.h"
#include "vad_audio_proc_internal.h"
extern "C" {
#include "../codecs/isac/filter_functions.h"
#include "../codecs/isac/isac_vad.h"
#include "../codecs/isac/pitch_estimator.h"
#include "../codecs/isac/structs.h"
}
