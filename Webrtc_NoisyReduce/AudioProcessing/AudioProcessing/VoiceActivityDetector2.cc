...
#include "agc2/agc2_common.h"
#include "agc2/rnn_vad/common.h"
#include "agc2/rnn_vad/features_extraction.h"
#include "agc2/rnn_vad/rnn.h"
...
class MonoVadImpl : public VoiceActivityDetector2::MonoVad {
 public:
...
VoiceActivityDetector2::VoiceActivityDetector2(
    const AvailableCpuFeatures& cpu_features,
    int sample_rate_hz)
    : VoiceActivityDetector2(kVadResetPeriodMs,
                                   cpu_features,
                                   sample_rate_hz) {}
...
VoiceActivityDetector2::VoiceActivityDetector2(
    ...
    const AvailableCpuFeatures& cpu_features,
    int sample_rate_hz)
    : VoiceActivityDetector2(vad_reset_period_ms,
...
void VoiceActivityDetector2::Initialize(int sample_rate_hz) {
...
float VoiceActivityDetector2::Analyze(AudioFrameView<const float> frame) {
