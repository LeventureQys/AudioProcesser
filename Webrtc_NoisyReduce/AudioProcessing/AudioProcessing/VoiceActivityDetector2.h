...
#include "agc2/available_cpu_features.h"
...
class VoiceActivityDetector2 {
 public:
  ...
  VoiceActivityDetector2(const AvailableCpuFeatures& cpu_features,
                               int sample_rate_hz);
  ...
  VoiceActivityDetector2(int vad_reset_period_ms,
  ...
  VoiceActivityDetector2(const VoiceActivityDetector2&) = delete;
  VoiceActivityDetector2& operator=(const VoiceActivityDetector2&) =
      delete;
  ~VoiceActivityDetector2();
