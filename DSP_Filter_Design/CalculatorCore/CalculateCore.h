...
public:
	...
	QMap<TFZType, TFZ_coefficients> MakeCoeffLowPassList(double freq_center);
	/// <summary>
	...
	QMap<TFZType,TFZ_coefficients> MakeCoeffBandList(BandType type, double center_freq, double QValue, double Gain);
	...
	QMap<TFZType, TFZ_coefficients> MakeCoeffHighPassList(double freq_center);
	/// <summary>
